...
@section('architecture')
    <div class="fluid intro" style="width: 650px;">
        <div id="owl" class="owl-carousel">
            <div>
                <a href="{{ route('1978-reel-boom', app()->getLocale() ) }}" class="fullsizable">
                    <img alt="1978 Reel Boom" src="#">
                    <p>1978 Reel Boom</p>
                </a>
            </div>
            <div>
                <a href="{{ route('1979-cubus-diebach', app()->getLocale() ) }}" class="fullsizable">
            ...
            <div>
                <a href="{{ route('1980-venezia-ponte-academia-1', app()->getLocale() ) }}" class="fullsizable">
            ...
            <div>
                <a href="{{ route('1980-venezia-ponte-academia-2', app()->getLocale() ) }}" class="fullsizable">
                    <img alt="1979 Cubus Diebach" title="1979 Cubus Diebach" src="{{url('/images/architectuur/icons/venezia-2.jpg')}}">
                    <p>1980 Venezia Ponte Academia</p>
                </a>
            </div>
            <div>
                <a href="{{ route('1980-villa-di-plinio-ostia', app()->getLocale() ) }}" class="fullsizable">
            ...
            <div>
                <a href="{{ route('2000-nazareth', app()->getLocale() ) }}" class="fullsizable">
                    <img alt="1979 Cubus Diebach" title="1979 Cubus Diebach" src="{{url('/images/architectuur/icons/nazareth.jpg')}}">
                    <p>2000 Nazareth</p>
                </a>
            </div>
            <div>
                <a href="{{ route('2001-genval-annex', app()->getLocale() ) }}" class="fullsizable">
            ...
            <div>
                <a href="{{ route('2001-genval-appartments', app()->getLocale() ) }}" class="fullsizable">
