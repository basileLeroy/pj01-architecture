...
<div class="w-full mx-12 flex flex-col items-center ">
    ...
    @if ($articles->isEmpty())
        ...
        <div id="accordion-collapse-body-fr" class="hidden w-full" aria-labelledby="accordion-collapse-heading-fr">
            ...
            <div class="flex flex-col gap-6 p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                <div class="w-1/2">
                    <label for="title-fr" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Title</label>
                    <input type="text" name="fr[title]" id="title-fr" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">    
                </div>
        ...
        <div id="accordion-collapse-body-en" class="hidden" aria-labelledby="accordion-collapse-heading-en">
            <div class="flex flex-col gap-6 p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                <div class="w-1/2">
                    <label for="title-en" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Title</label>
                    <input type="text" name="en[title]" id="title-en" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">    
                </div>
        ...
        <div id="accordion-collapse-body-nl" class="hidden" aria-labelledby="accordion-collapse-heading-nl">
            <div class="flex flex-col gap-6 p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                <div class="w-1/2">
                    <label for="title-nl" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Title</label>
                    <input type="text" name="nl[title]" id="title-nl" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">    
                </div>
    ...
    @foreach ($articles as $article)
        ...
        <div id="accordion-collapse-body-{{$article->language}}" class="hidden" aria-labelledby="accordion-collapse-heading-{{$article->language}}">
            <div class="flex flex-col gap-6 p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                <div class="w-1/2">
                    <label for="title-{{$article->language}}" class="block mb-2 text-md font-medium text-gray-900 dark:text-white">Title</label>
                    <input type="text" value="{{$article->title}}" name="{{$article->language}}[title]" id="title-{{$article->language}}" class="bg-gray-100 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">    
                </div>
