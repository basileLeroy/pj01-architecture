    ...
    <form action="{{route("admin.projects.update-order")}}" method="post" id="projects-list" class="w-full flex flex-wrap gap-7 justify-around bg-slate-100 p-12 mb-12 rounded-md">
        ...
        <div id="project-item" draggable="true" class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
            ...
            <div class="flex justify-end px-4 pt-4">
                ...
                <!-- Dropdown menu -->
                <div id="dropdown-{{$project->id}}" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                    <ul class="py-2" aria-labelledby="{{$project->slug}}">
                    <li>
                        <a href="{{route("admin.projects.edit", ["Project" => $project->slug])}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Edit</a>
                    </li>
                    <li>
