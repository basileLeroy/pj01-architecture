...
@section('content')
    ...
    <div id="page" class="w-full mx-12 flex flex-col items-center ">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('admin.projects.store') }}"
            ...
            <div class="my-5">
                <label for="title-input" class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Titre du projet
                    *</label>
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="gallery-images">Ajouter des
                    images de gallerie</label>
                <input
                    class="block w-full text-sm text-gray-900 border border-gray-300 rounded-lg cursor-pointer bg-gray-50 dark:text-gray-400 focus:outline-none dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400"
            ...
            @foreach ($projects as $project)
                <div id="project-item" draggable="true"
                    ...
                    <div class="flex justify-end px-4 pt-4">
                        <button id="{{ $project->slug }}" data-dropdown-toggle="dropdown-{{ $project->id }}"
                        ...
                        <div id="dropdown-{{ $project->id }}"
                            ...
                            <ul class="py-2" aria-labelledby="{{ $project->slug }}">
                                <li>
            ...
            <div class="relative bg-white rounded-lg shadow dark:bg-gray-700">
                ...
                <div class="p-4 md:p-5 text-center">
                    ...
                    <h3 class="mb-5 text-lg font-normal text-gray-500 dark:text-gray-400">Are you sure you want to delete
                        this project?</h3>
                    <a data-modal-hide="popup-modal" href="{{ route('admin.projects.delete', ['Project' => $project->slug]) }}"
