...
<div class="w-full mx-12 flex flex-col items-center ">
    ...
    <form enctype="multipart/form-data" action="{{ route('admin.projects.update', ["Project" => $firstProject->slug])}}" method="POST" class="w-full">
        @csrf
        <div id="accordion-collapse" class="w-full" data-accordion="collapse">
            <h2 id="accordion-collapse-heading-images">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-images" aria-expanded="false" aria-controls="accordion-collapse-body-images">
            ...
            <div id="accordion-collapse-body-images" class="hidden" aria-labelledby="accordion-collapse-heading-{{$firstProject->language}}">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                    ...
                    <h3 class="block mb-2 text-sm font-medium text-gray-900 dark:text-white">Cliquer sûr une image pour supprimer</h3>
                    <ul class="flex w-full gap-6 mb-5">
                        @foreach ($firstProject->gallery as $image)
                        <li>
                            <input type="checkbox" id="project-image-{{$loop->index}}" name="deletions[]" value="{{$image}}" class="hidden peer">
                            <label for="project-image-{{$loop->index}}" class="inline-flex w-36 p-5 bg-white border-2 border-gray-200 rounded-lg cursor-pointer dark:border-gray-700 peer-checked:border-red-600 hover:bg-gray-50 dark:bg-gray-800 dark:hover:bg-gray-700">                           
                                <div class="block">
        ...
        @foreach ($projects as $project)
            <h2 id="accordion-collapse-heading-{{$project->language}}">
                <button type="button" class="flex items-center justify-between w-full p-5 font-medium rtl:text-right text-gray-500 border border-b-0 border-gray-200 focus:ring-4 focus:ring-gray-200 dark:focus:ring-gray-800 dark:border-gray-700 dark:text-gray-400 hover:bg-gray-100 dark:hover:bg-gray-800 gap-3" data-accordion-target="#accordion-collapse-body-{{$project->language}}" aria-expanded="false" aria-controls="accordion-collapse-body-{{$project->language}}">
            ...
            <div id="accordion-collapse-body-{{$project->language}}" class="hidden" aria-labelledby="accordion-collapse-heading-{{$project->language}}">
                <div class="p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                    ...
                    <div class="my-5">
                        ...
                        <input type="text" value="{{$project->title}}" name="{{$project->language}}[title]" id="title-input" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500">
                    </div>
