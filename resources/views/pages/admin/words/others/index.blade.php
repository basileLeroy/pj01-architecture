...
@vite(["resources/js/admin.js"])
    ...
    <div class="w-full mx-12 flex flex-col items-center ">
        ...
        <form enctype="multipart/form-data" method="POST" action="{{ route('admin.words.others.store') }}"
            ...
            <div class="mb-5">
                <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="author">Auteur(e) *</label>
                <input
        ...
        <div class="w-full flex flex-wrap gap-7 justify-around bg-slate-100 p-12 mb-12 rounded-md">
            ...
            <form id="words-list" action="{{route("admin.words.others.update-order")}}" method="post" id="articles-list" class="w-full flex flex-wrap gap-7 justify-around bg-slate-100 p-12 mb-12 rounded-md">
                @csrf   
                ...
                <div id="article-item-{{$article->id}}" draggable="true" class="w-full max-w-sm bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <div class="flex justify-end px-4 pt-4">
                        ...
                        <div id="dropdown-{{$article->id}}" class="z-10 hidden text-base list-none bg-white divide-y divide-gray-100 rounded-lg shadow w-44 dark:bg-gray-700">
                            ...
                            <li>
                                <a href="{{route("admin.words.others.editDetail", ["Word" => $article->slug])}}" class="block px-4 py-2 text-sm text-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 dark:text-gray-200 dark:hover:text-white">Edit</a>
                            </li>
                            <li>
