    ...
    <div class="w-full mx-12 flex flex-col items-center ">
        ...
        <form enctype="multipart/form-data" action="{{ route('admin.words.marc.update') }}" method="POST" class="w-full">
            ...
            <div id="accordion-collapse" class="w-full" data-accordion="collapse">
                ...
                <div id="accordion-collapse-body-cover" class="hidden"
                    aria-labelledby="accordion-collapse-heading-cover">

                    <div class="flex items-center gap-6 p-5 border border-b-0 border-gray-200 dark:border-gray-700 w-full">
                        <img id="cover-display" class="max-h-28 w-auto mx-5 rounded-lg" src="{{asset($page->cover)}}" alt="Cover image for {{$page->title}}">
                        <div class="mb-5 w-full">
                            <label class="block mb-2 text-sm font-medium text-gray-900 dark:text-white" for="cover-image">Changer l'image de couverture</label>
