...
return [ 
    'articleWebsite' => 
        ...
        et les pensées y afférentes.<br/>
        Il y a des dessins, des projets<br/>
        et il y a des mots, des textes, des photos.<br/>
        Tout y insiste sur la notion d’architecturer.
        <br/><br/>
        Ce site s’ouvre<br/>
        au même titre<br/>
        à ceux qui désirent réaliser un projet ou un travail<br/>
        avec Marc Belderbos<br/>
        et à ceux qui désirent échanger avec lui, intervenir sur le site, ou dans ce réseau (.net) sur le thème: architecturer.
        <br/><br/>
        Le nom de ce site en réseau de pensées<br/>
        est donc ‘architecturer’.<br/>
        Ce nom est un ‘verbe’ inscrit sur la première page de ‘Vers une architecture’ du Corbusier qui avait aussi bien senti la préséance, pour l’humain, de l’’architecturer’ sur l’architecture : “<span style='font-style: italic; font-weight: bold;'>….Architecturer! ce n’est pas là que travail technique de professionnel. 
        ...
        <br/><br/>
        ‘Architecturer’ indique une inclination précise vers l’architecture,<br/>
        non comme ‘objet’ ou ‘produit’<br/>
        d’un producteur ou du seul auteur<br/>
        mais comme une opération éthique dans le réel.
        <br/><br/>
        C’est à ce désir-là de vivre avec et de travailler à<br/>
        cette notion et cette pratique - ’architecturer’-<br/>
        que tous sont conviés:<br/>
        Clients, critiques, théoriciens, amateurs d’architecture,<br/>
        et tous ceux qui pensent.
        <br/><br/>
        Architecturer est une proposition<br/>
        qui précède le sujet et l’objet.<br/>
        Architecturer est un verbe.<br/>
        Contempler l’architecture c’est contempler un verbe.
        <br/><br/>
